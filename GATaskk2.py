...
def seleksiindividu(child):
  ...
  print("Replace index :",idxkcl,fitptr)
...
print("POPULASI  GENERASI PERTAMA")
ukuranpopulasi()
print("==========================")
...
while(loop < limit):
  ...
  print("POINT UTAMA : ",pntr,"POINT LAINNYA : ",otherpntr)
  child = Cross(pop[par[0]].gen,pop[par[1]].gen,pntr , otherpntr)
  print("PANJANG ANAK A : ",len(child[0]))
  print("PANJANG ANAK B : ",len(child[1]))
  print("MUTASI")
  child[0] = mutasi(child[0])
  child[1] = mutasi(child[1])
  print("SELEKSI INDIVIDU")
